...
contract TSanCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    constructor() {
        ...
        name = "TSanCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "TSAN";                                             // Set the symbol for display purposes (CHANGE THIS)
